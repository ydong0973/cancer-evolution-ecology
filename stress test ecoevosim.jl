...
z0, eta, sigma = 0.3, 0.2, 0.13 #evolving trait (proliferation capacity), smoothness of the transition , transition width (!= 0) -- default is 0.5, 0.2, 0.13
at, rt = 1e-14, 1e-8 #absolute and relative tolerance 
et = 0.003 #extThreshold
mv, iv, n= 0.001^2, 0.001, 10000 #mutation variance, invaderPopsize, mutation steps (10_000) #50000? 
z_init = 0.3 #0.5? 
